      ...
      <Container maxWidth="md">
        <Box className={classes.root} style={{ margin: "auto", marginTop: 50 }}>
          <ExpansionPanel
            ...
            onChange={() => setTestsExpanded(!testsExpanded)}
          >
          ...
          <ExpansionPanel
            className={classes.expansion}
            expanded={diseasesExpanded}
            onChange={() => setDiseasesExpanded(!diseasesExpanded)}
          >
            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <ExpansionPanelDetails>
              <DiseaseSettings
                ...
                onSelectedChange={(disease) => {
                  props.toggleDisease(disease);
                }}
                dense
              />
            </ExpansionPanelDetails>
          ...
          <ExpansionPanel
            ...
            onChange={() => setPatientExpanded(!patientExpanded)}
          >
            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
          ...
          <Box pt={4}>
            <Button
              ...
              onClick={() => {
                props.setReportResult( generateLabResults(props.tests, props.disease, props.patient) );
              }}
            >
              Create Lab Report
            </Button>
